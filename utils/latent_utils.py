...
def get_input_train(args):
    ...
    ckpt_dir = f'{args.method}/ckpt/{dataname}/'
    embedding_save_path = f'vae/ckpt/{dataname}/train_z.npy'
    ...
    return train_z, args.method, dataset_dir, ckpt_dir, info
...
def get_input_generate_disc(args):
    ...
    ckpt_dir = f'{args.method}/ckpt/{fewshot_name}'
    ...
    ckpt_dir = f'{args.method}/ckpt/{pretrain_name}'
    disc_dir = f'discriminator/ckpt/{fewshot_name}'
...
def get_input_generate(args):
    ...
    dataset_dir = f'data/{dataname}'
    ckpt_dir = f'{args.method}/ckpt/{dataname}'
    disc_dir = f'discriminator/ckpt/{args.method}/{dataname}'
    ...
    decoder_save_path = f'vae/ckpt/{dataname}/decoder.pt'
    pre_decoder.load_state_dict(torch.load(decoder_save_path))

    info['pre_decoder'] = pre_decoder
    info['token_dim'] = token_dim

    return train_z, dataset_dir, ckpt_dir, disc_dir, info, num_inverse, cat_inverse
